...
// 	port: PORT,
// 	cert: fs.readFileSync("/var/ssl/public/cert.cer"),
// 	key: fs.readFileSync("/var/ssl/private/server.pfx")
// })
	...
	constructor( ws )
	{
		...
		this.timeout = setTimeout( () =>
		{
			if( !this.game )
				...
				console.log('Closing connection: NO LOBBY')
		}, NO_LOBBY_TIMEOUT );
	}
...
wss.on( "connection", ( ws ) =>
{
	...
	ws.on( "message", ( message ) =>
	{
		if( typeof message !== "string" )
		{
			...
			console.log("Closing connection: INVALID_TRANSFER_MODE")
			return;
		}
		...
		} catch( e )
		{
			...
			console.log("Closing connection: Error parsing message: " + e.message)
	...
	{
		peersCount--;
		console.log( `Connection with peer ${peer.id} closed, reason: ${reason}, code: ${code}` );
